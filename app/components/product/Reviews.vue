...
const limitedTestimonials = computed(() => testimonials.value.slice(0, maxTestimonials));
...
<template>
    ...
    <UPageColumns>
        <UPageCard v-for="(testimonial, index) in limitedTestimonials" :key="index" variant="subtle"
